...
import PlaySound from './moogic/Sound';
import ScrollButton from './components/Scroll';
import { Fragment } from 'react';
// import { Content, Heading } from './components/ScrollStyle';
  ...
  const handleKeyPress= (key)=>{
    ...
    if(key==="ENTER"){
        if(charArray.length===5){
            ...
            handleMessage("Recheck No of Letters");
        }
        return;
    }
    if(key==="⌫"){
...
// }
  return (
        <div className='container'>
          ...
          {/* <div>Created by Settipalli Shanmukha Sai Srinivas</div> */}
          ...
          {/* <div className='title'>Developed by Settipalli Shanmukha Sai Srinivas</div> */}
          <Fragment>
